 ...
 * @author nga_a
 */
public class RegistrarEntradaSalida extends javax.swing.JFrame {

    /**
     * Creates new form RegistrarEntradaSalida
     */
    public RegistrarEntradaSalida() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarEntradaSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarEntradaSalida().setVisible(true);
            }
        });
    }
